...
from plugins.lo-reninge_trash.admin import StatsHandler
from plugins.lo-reninge_trash.cron import BroadcastNotificationsHandler
from plugins.lo-reninge_trash.rogerthat_callbacks import system_api_call
from framework.utils.plugins import Handler
from plugins.rogerthat_api.rogerthat_api_plugin import RogerthatApiPlugin

class Lo-ReningeTrashPlugin(Plugin):

    def __init__(self, configuration):
        super(Lo-ReningeTrashPlugin, self).__init__(configuration)
