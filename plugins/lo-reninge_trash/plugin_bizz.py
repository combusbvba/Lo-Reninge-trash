...
from plugins.lo-reninge_trash.models import UserLocation
from plugins.lo-reninge_trash.plugin_consts import HTTPS_BASE_URL, ROGERTHAT_EXCEPTION_CODE_SERVICE_USER_NOT_FOUND, \
    ROGERTHAT_EXCEPTION_CODE_MESSAGE_USER_NOT_FOUNDS
from plugins.lo-reninge_trash.plugin_utils import today
from plugins.lo-reninge_trash.to import HouseTO, StreetTO, ActivityTO, CollectionTO
...
def get_api_streets(sik):
    ...
    sdata = {}
    sdata['field_gemeente_value'] = 'Lo-Reninge'
...
def get_api_collections(sik, street_name, house_number, house_bus, time_from):
    ...
    f = { 'field_gemeente_value' : 'Lo-Reninge', 'field_straat_value' : street_name.encode('utf-8'), 'field_straatnrvan_value' : house_number}
